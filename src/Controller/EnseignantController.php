...
class EnseignantController extends AbstractController
{
    ...
    public function new(Request $request,UserPasswordHasherInterface $enseignantPasswordHasher, EnseignantRepository $enseignantRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $enseignant->setPassword(
                $enseignantPasswordHasher->hashPassword(
                    $enseignant,
